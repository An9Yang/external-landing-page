          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-20 mb-12">
              <div className="space-y-1">
                <div className="text-[48px] font-black text-fs-orange">12</div>
                <div className="text-[14px] text-foreground/60">Years of Experience</div>
              </div>
              <div className="space-y-1">
                <div className="text-[48px] font-black text-fs-orange">270</div>
                <div className="text-[14px] text-foreground/60">Completed Projects</div>
              </div>
              <div className="space-y-1">
                <div className="text-[48px] font-black text-fs-orange">50+</div>
            ...
            <div className="flex gap-4 mb-12">
              {/* X (Twitter) */}
              <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full border border-foreground/20 hover:border-fs-orange transition-colors">
